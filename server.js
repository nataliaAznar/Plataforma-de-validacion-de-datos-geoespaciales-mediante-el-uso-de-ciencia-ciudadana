var express = require("/usr/lib/node_modules/express"),
    ...
    port = 3001,
    fs = require('fs'),
    obtener = require('/var/www/localhost/htdocs/validator/api/obtenerLatLon'),
    mostrarErrores = require('/var/www/localhost/htdocs/validator/api/mostrarErrores'),
    updateError = require('/var/www/localhost/htdocs/validator/api/updateError'),
    getError = require('/var/www/localhost/htdocs/validator/api/getError'),
    ...
    getErroresBoundingBox = require('/var/www/localhost/htdocs/validator/api/getErroresBoundingBox'),
    getErroresLimitadosBoundingBox = require('/var/www/localhost/htdocs/validator/api/getErroresLimitadosBoundingBox'),
    importer = require('/var/www/localhost/htdocs/validator/importers/importer'),
